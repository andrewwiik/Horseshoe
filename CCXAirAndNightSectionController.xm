...
+ (UIImage *)sectionImage {
	return [[UIImage imageNamed:@"Button_Section" inBundle:[NSBundle bundleWithPath:@"/Library/Application Support/Horseshoe.bundle/"]] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
}
