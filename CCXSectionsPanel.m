...
- (void)loadSections {
	...
	[sections addObject:[[CCXSectionObject alloc] initWithSectionClass:NSClassFromString(@"CCXMultiSliderSectionController")]];
	[sections addObject:[[CCXSectionObject alloc] initWithSectionClass:NSClassFromString(@"CCUIBrightnessSectionController")]];
	[sections addObject:[[CCXSectionObject alloc] initWithSectionClass:NSClassFromString(@"CCXVolumeSectionController")]];
