...
- (void)viewDidLoad {
	...
	if (self.isNoctisInstalled) {
		[self.view setSubstitutedBackgroundColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.15]];
		[self.view setDarkModeEnabled:CFPreferencesGetAppBooleanValue((CFStringRef)@"LQDDarkModeEnabled", CFSTR("com.laughingquoll.noctis"), NULL)];
		[[self.view layer] setSubstitutedContentsMultiplyColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.15]];
		[[self.view layer] setDarkModeEnabled:CFPreferencesGetAppBooleanValue((CFStringRef)@"LQDDarkModeEnabled", CFSTR("com.laughingquoll.noctis"), NULL)];
	}
