...
+ (UIImage *)sectionImage {
	return [[UIImage imageNamed:@"Shortcuts_Section" inBundle:[NSBundle bundleWithPath:@"/Library/Application Support/Horseshoe.bundle/"]] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
}
